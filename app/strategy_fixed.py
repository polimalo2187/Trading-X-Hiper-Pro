...
# ------------------------------
TP_WEAK_ACTIVATE_PRICE = 0.009
TP_BASE_ACTIVATE_PRICE = 0.012
TP_STRONG_ACTIVATE_PRICE = 0.016

TRAIL_WEAK_RETRACE_PRICE = 0.0030
TRAIL_BASE_RETRACE_PRICE = 0.0035
TRAIL_STRONG_RETRACE_PRICE = 0.0030

FORCE_MIN_PROFIT_WEAK = 0.005
FORCE_MIN_PROFIT_BASE = 0.006
FORCE_MIN_PROFIT_STRONG = 0.008
FORCE_MIN_STRENGTH_FLOOR = 0.18
FORCE_STRENGTH_FRAC = 0.60
