...
def _passes_5m_timing_filters(
    ...
    try:
        ...
        if dir_l == "long":
            ...
            # Entrada más temprana: permitir ruptura por HIGH (wick) para no entrar tarde.
            ...
            if not _market_expansion_ok(h, lo, mult=1.10):
                return False, "MARKET_NO_EXPANSION", {"m": m}
        ...
        # Entrada más temprana: permitir ruptura por LOW (wick) para no entrar tarde.
