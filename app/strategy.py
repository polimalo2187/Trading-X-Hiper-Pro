...
TIMING_MIN_BODY_RATIO = 0.50 # vela con cuerpo decente (calidad)
TIMING_MIN_RANGE_ATR_MULT = 0.58 # rango mínimo vs ATR (evita velas muertas)
...
TIMING_EMA_TOL_PCT = 0.0035       # tolerancia % alrededor de EMA20 para no quedar fuera por centavos
...
def get_entry_signal(symbol: str) -> dict:
    try:
        ...
        if adx15_last is None:
            return {"signal": False, "reason": "ADX_15M", "coin": coin, "adx_15m": None}
