...
def get_trade_management_params(strength: float, score: float) -> Dict[str, Any]:
    """API pública para que el engine pueda reconstruir TP dinámico / trailing
    usando el strength/score original persistido del trade.
    """
    return _dynamic_trade_management_params(float(strength or 0.0), float(score or 0.0))
# ------------------------------
...
def get_entry_signal(symbol: str) -> dict:
    try:
        ...
        mgmt = _dynamic_trade_management_params(float(strength), float(score))
