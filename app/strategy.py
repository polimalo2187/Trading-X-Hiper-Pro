...
# Gestión dinámica de salidas calculada por estrategia (el engine solo ejecuta)
TP_ACTIVATE_WEAK_PRICE = 0.012
TP_ACTIVATE_BASE_PRICE = 0.014
TP_ACTIVATE_STRONG_PRICE = 0.016

TRAIL_RETRACE_MIN_PRICE = 0.0030
TRAIL_RETRACE_MAX_PRICE = 0.0045

FORCE_MIN_PROFIT_MIN_PRICE = 0.0060
FORCE_MIN_PROFIT_MAX_PRICE = 0.0130
FORCE_MIN_STRENGTH_FLOOR = 0.18
FORCE_MIN_STRENGTH_FRAC = 0.60
...
def get_entry_signal(symbol: str) -> dict:
    try:
        ...
        out = {
            ...
            **_dynamic_trade_management_params(strength=float(strength), score=float(score), atr_pct=float(atr_pct)),
