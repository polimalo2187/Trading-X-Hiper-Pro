...
# Archivo 10/10 – Operaciones reales 24/7 (FINAL – PRODUCCIÓN)
# ============================================================
...
# ============================================================
# ESTADO EN MEMORIA (ANTI-SPAM)
# ============================================================

scanning_notified = set()
    ...
    while True:
        try:
            ...
            for user in users:
                ...
                # 🔍 MENSAJE ÚNICO DE ESCANEO
                if user_id not in scanning_notified:
                    await send_message_safe(
                        app,
                        user_id,
                        "🔍 *Escaneando mercado en tiempo real…*"
                    )
                    scanning_notified.add(user_id)

                # ▶️ EJECUCIÓN DEL TRADE
