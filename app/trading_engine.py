...
# 🔥 CONTROL ANTI-BUCLE (FIX DEFINITIVO)
MAX_FAILED_SIGNALS = 3          # intentos sin señal
BLACKLIST_MINUTES = 10          # castigo por activo
...
def execute_trade(user_id: int):
    ...
    while True:
        ...
        # 2) SCANNER (forzar rotación REAL)
        best = None
        attempts = 0
