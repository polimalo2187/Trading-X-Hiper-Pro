...
# Cooldown para rotar símbolos cuando no hay señal (no es error)
...
def execute_trade_cycle(user_id: int) -> dict | None:
    ...
    # Excluir símbolos en cooldown y blacklist para forzar rotación
    # FIX: iterar sobre COPIA de keys para evitar "dict changed size during iteration"
