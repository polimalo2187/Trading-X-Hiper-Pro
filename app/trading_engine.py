...
def execute_trade_cycle(user_id: int) -> dict | None:
    ...
    try:
        ...
        # Risk solo para trailing_pct (no tocamos risk.py)
        ...
        while True:
            ...
            if not trailing_active:
                if direction == "long" and price >= tp_min_price:
                    ...
                    log(f"TRAIL activado {symbol} best={best_price:.8f} stop={trailing_stop:.8f} (tp_min=1.0%, piso=0.8%)", "INFO")
