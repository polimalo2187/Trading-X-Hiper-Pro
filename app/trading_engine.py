...
# Si un usuario se queda con el MISMO símbolo sin señal por mucho tiempo,
# lo rotamos a otro símbolo sin afectar la estrategia.
...
def _register_no_signal_and_maybe_rotate(user_id: int, symbol: str, reason: str | None = None):
    """
    Suma conteo de ciclos sin señal para el símbolo actual del usuario.
    Si se excede tiempo o conteo, ponemos cooldown y liberamos el símbolo preferido.
    """
...
def execute_trade_cycle(user_id: int) -> dict | None:
    ...
    # Estado “pegado” por usuario/símbolo
    ...
    if not signal.get("signal"):
        ...
        # ✅ Aquí está el fix: si se queda mucho tiempo sin señal, rotamos
