...
TP_ACTIVATE_TRAIL_PRICE = 0.018  # ACTIVA TRAILING 1.8% PRECIO (x5=9% ROE)
TRAIL_RETRACE_PRICE = 0.0035  # RETROCESO 0.35% PRECIO (x5=1.75% ROE)

# ✅ SL por fuerza
SL_MIN_PRICE = 0.012  # SL FIJO 1.2% PRECIO (x5=6% ROE)
