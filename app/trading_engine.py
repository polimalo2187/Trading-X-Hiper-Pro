...
MAX_TRADE_DURATION_SECONDS = 60 * 6      # ⬅ más rápido (antes 10 min)
PRICE_CHECK_INTERVAL = 0.4               # ⬅ más reactivo
...
def execute_trade(user_id: int):
    ...
    # 🔥 ESCALADO DINÁMICO DE POSICIÓN (CLAVE DE GANANCIA)
