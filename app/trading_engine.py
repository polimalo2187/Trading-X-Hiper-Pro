...
from app.hyperliquid_client import place_market_order, place_sl_trigger, cancel_order_by_oid, get_price, get_balance, has_open_position, get_position_entry_price
...
# ✅ FSL (Stop Loss fijo) SIEMPRE por % de PRECIO (sin ROE)
SL_PRICE_PCT = 0.011700  # 1.17% de precio
