...
# ============================================================
# SYMBOL NORMALIZATION (🔥 CLAVE DEL FIX)
# ============================================================

def normalize_symbol(symbol: str) -> str:
    """
    Convierte BTC-PERP -> BTC
    """
...
def execute_trade_cycle(user_id: int) -> dict | None:
    ...
    raw_symbol = best["symbol"]          # BTC-PERP
    symbol = normalize_symbol(raw_symbol)  # BTC

    log(f"Simbolo elegido: {raw_symbol} → {symbol}")
