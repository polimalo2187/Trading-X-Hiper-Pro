...
async def set_pk(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.callback_query.edit_message_text(
        ...
        "(No se valida formato por seguridad.)",
        parse_mode="Markdown"
    )


# ============================================================
# INPUTS (wallet, pk, capital)
# ============================================================
...
async def text_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if context.user_data.get("awaiting_pk"):
        ...
        await update.message.reply_text(
            "🔐 Private Key guardada correctamente.",
            reply_markup=main_menu()
        )
        return
...
# ============================================================
# VOLVER AL MENÚ PRINCIPAL (desde submenús)
# ============================================================

async def back_to_main(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """
    Handler seguro para el botón ⬅ Volver.
    No usa update.message (que es None en callbacks),
    siempre trabaja sobre callback_query.
    """
    q = update.callback_query
    user_id = q.from_user.id
...
def run_bot():
    # Inicializar base de datos (tablas listas antes de operar)
    init_db()
    ...
    # Iniciar trading loop 24/7 una sola vez
