...
# Archivo 8/9 – Sistema de control vía Telegram
# ============================================================
...
async def earnings_admin(update, context):
...
def run_bot():
    ...
    app.job_queue.run_once(lambda ctx: asyncio.create_task(trading_loop()), when=3)
