...
# ============================================================
# PARAMETROS OFICICIALES (PRODUCCIÓN REAL)
# ============================================================

# ✅ CAMBIO: antes 0.035 (3.5%) -> ahora 0.025 (2.5%)
TP_MIN_FIXED = 0.025      # 2.5% (mínimo para activar trailing)
...
# ============================================================
# VALIDAR CONDICICIONES + TAMAÑO DE POSICIÓN
# ============================================================
...
def validate_trade_conditions(balance: float, strength: float) -> dict:
    ...
    - TP mínimo (2.5%) para activar trailing
