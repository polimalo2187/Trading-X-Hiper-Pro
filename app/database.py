...
# ============================================================
# 🔴 FUNCIÓN NUEVA (ÚNICA) – A2
# LISTAR REFERIDOS CON SALDO PARA PAGO SEMANAL
# ============================================================

def get_referrers_with_balance():
    """
    Devuelve lista de referidores con saldo semanal acumulado > 0.
    Solo lectura. No altera lógica existente.
    """
    pipeline = [
        {
            "$group": {
