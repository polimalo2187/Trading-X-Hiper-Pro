...
DB_NAME = "TRADING_X_HIPER_PRO"   # ← CORREGIDO (sin espacios ni guiones)
...
def reset_daily_fees():
    admin_daily_fees_col.delete_many({})
...
def reset_weekly_fees():
    referral_weekly_fees_col.delete_many({})


# ============================================================
# LOG DE PAGOS (ADMIN / REFERIDOS)
# ============================================================

def log_fee_payment(payment_type: str, amount: float):
...
# ============================================================
# A2 – AUDITORÍA / ANTI DOBLE PAGO (SIN CAMBIAR LÓGICA EXISTENTE)
# ============================================================

def payment_exists(payment_type: str, beneficiary_id: int, period_id: str) -> bool:
    """
    Verifica si un pago ya fue realizado para evitar doble pago.
    """
...
def log_payment(payment_type: str,
                beneficiary_id: int,
                amount: float,
                currency: str,
                period_id: str,
                tx_hash: str):
    """
    Registra un pago on-chain ejecutado (auditoría bancaria).
    """
    fee_payments_col.insert_one({
        "payment_type": payment_type,
        "beneficiary_id": beneficiary_id,
