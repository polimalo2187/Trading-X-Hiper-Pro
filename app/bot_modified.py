...
async def info(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Info de operación: por ahora, mostramos la última operación cerrada registrada.
    trades = get_user_trades(user_id)
    last = trades[0] if trades else None

    msg = "📌 *INFORMACIÓN DE OPERACIÓN*
───────────────────────────
"

    # Operación abierta (se completará cuando trading_loop guarde last_open)
