...
MAX_SL_PRICE_PCT = 0.01  # límite duro: el SL nunca puede exceder 1% del precio
# ============================================================
...
def execute_trade_cycle(user_id: int) -> dict | None:
    ...
    try:
        ...
        if sl_price_pct > MAX_SL_PRICE_PCT:
            log(
                f"SL limitado por engine: original={sl_price_pct:.6f} -> max={MAX_SL_PRICE_PCT:.6f}",
                "WARN",
            )
            sl_price_pct = MAX_SL_PRICE_PCT
