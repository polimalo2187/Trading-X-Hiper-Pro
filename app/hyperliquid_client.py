# ============================================================
# HYPERLIQUID CLIENT – Compacto y estable (COMPAT READY)
...
def make_request(
    ...
    """
    Wrapper compatible con el cliente viejo.
    - Respeta retries/backoff de forma simple.
    """
    last = None
...
def _fmt_price(px: float, is_buy: bool) -> str:
    # Precio como string con 6 decimales, sin reglas raras con szDecimals
    try:
...
# ---------------------------
# Parse exchange statuses (primer status)
# ---------------------------
...
def place_market_order(
    ...
    # slippage simple (sin adaptativo / sin retries extra)
