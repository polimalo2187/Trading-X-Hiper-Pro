...
# ============================================================
# OBTENER BALANCE REAL USDC PERP
# ============================================================

def get_balance(user_id):
    wallet = get_user_wallet(user_id)
    if not wallet:
        print("❌ Usuario sin wallet.")
        return 0
...
# ============================================================
# FIRMA EIP-712 REAL PARA ÓRDENES
# ============================================================
...
# ============================================================
# ORDEN REAL MARKET (ENTRADA / SALIDA)
# ============================================================
...
def place_market_order(user_id, symbol, side, qty):
    ...
    if not private_key:
        print("❌ Usuario NO tiene PRIVATE KEY.")
        return None
    ...
    if not r:
        print("❌ Exchange respondió vacío.")
        return None
    ...
    print("❌ Orden rechazada por el exchange:", r)
    return None
