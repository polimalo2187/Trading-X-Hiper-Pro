...
def safe_log(*args):
    # Nota: tú tienes VERBOSE_LOGS=True aunque PRODUCTION_MODE=True.
    # Lo respetamos tal cual para que puedas depurar en prod.
    ...
    for attempt in range(1, retries + 1):
        try:
            ...
            if r.status_code == 429 or 500 <= r.status_code <= 599:
                ...
                if attempt < retries:
                    # backoff más fuerte para 429/5xx
...
def place_market_order(
    ...
    for attempt in range(1, total_attempts + 1):
        ...
        # ✅ Payload incluye expiresAfter (compat estable)
        payload = {
            "action": action,
            "nonce": nonce,
            "signature": signature,
