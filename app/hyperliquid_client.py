...
def _refresh_meta_cache():
    ...
    try:
        ...
        for i, item in enumerate(universe):
            ...
            # Tick size: algunos assets requieren que el precio sea múltiplo del tick.
            tick_candidates = []
            try:
            ...
            if tick_candidates:
                # Elegimos el tick más pequeño positivo (más estricto).
                asset_to_tick[i] = float(min(tick_candidates))
            else:
                asset_to_tick[i] = 0.0
