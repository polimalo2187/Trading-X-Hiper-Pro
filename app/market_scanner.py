...
# ============================================================
# 1. Obtener estadísticas 24h reales (HYPERLIQUID REAL)
# ============================================================

def get_all_24h_stats():
    """Devuelve mapa limpio de stats reales."""

    # ✅ TYPE CORRECTO (FIX DEFINITIVO 422)
...
# ============================================================
# 2. Analizar un par (SCORE AGRESIVO – MODO GUERRA)
# ============================================================
...
# ============================================================
# 3. Seleccionar el mejor par del mercado (AGRESIVO)
# ============================================================
...
def get_best_symbol() -> dict | None:
    ...
    safe_log(
        ...
        f"Score {best['score']} | Vol {best['volume_usd']} | OI {best['open_interest_usd']}"
    )
